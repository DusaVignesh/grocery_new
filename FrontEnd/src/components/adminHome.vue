...
export default {
  ...
  methods: {
    async fetchCategoriesWithProducts() {
      ...
      try {
        const response = await axios.get(
          'http://54.79.249.44:3000/getcategories_products',
        )
    ...
    async fetchStoreManagers() {
      ...
      try {
        const response = await axios.get('http://54.79.249.44:3000/store_requests')
        console.log(response)
    ...
    async fetchDeleteProducts() {
      ...
      try {
        const res = await axios.get('http://54.79.249.44:3000/deleteProducts')
        console.log(res)
    ...
    async fetchCategories() {
      ...
      try {
        const response = await axios.get('http://54.79.249.44:3000/getCategories')
        console.log(response)
    ...
    acceptCredentials(userId) {
      ...
      axios
        .post('http://54.79.249.44:3000/accept', {id: userId})
        .then(response => {
    ...
    rejectCredentials(userId) {
      ...
      axios
        .post('http://54.79.249.44:3000/reject', {id: userId})
        .then(response => {
          console.log(response.data.message)
          this.fetchStoreManagers()
        })
    ...
    deleteProduct(productId) {
      ...
      axios
        .post('http://54.79.249.44:3000/deleteProduct', {id: productId})
        .then(response => {
          console.log(response.data.message)
          this.fetchDeleteProducts()
        })
    ...
    undeleteProduct(productId) {
      //api call for deleting the product completely from database using productId
      axios
        .post('http://54.79.249.44:3000/undeleteProduct', {id: productId})
        .then(response => {
          console.log(response.data.message)
          this.fetchDeleteProducts()
        })
